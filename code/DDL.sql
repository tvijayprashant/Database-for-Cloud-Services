...
ALTER TABLE VM ADD CONSTRAINT FK_VM_TRANSFER_VM FOREIGN KEY (TRANSFER_VM_ID) REFERENCES VM(VM_ID);
...
ALTER TABLE RUNTIME ADD CONSTRAINT FK_RUNTIME_VM_ID FOREIGN KEY (VM_ID) REFERENCES VM(VM_ID);
...
ALTER TABLE MONITORS ADD CONSTRAINT FK_MONITORS_TIME FOREIGN KEY (VM_ID,TIME) REFERENCES RUNTIME(VM_ID,TIME);
-- ALTER TABLE MONITORS ADD CONSTRAINT FK_MONITORS_VM_ID FOREIGN KEY (VM_ID) REFERENCES VM(VM_ID);

ALTER TABLE ACCESS ADD CONSTRAINT FK_ACCESS_VM_ID FOREIGN KEY (VM_ID) REFERENCES VM(VM_ID);
