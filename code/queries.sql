...
select VM_ID,AVG(RAM_USAGE) as RAM_USAGE,AVG(CPU_USAGE) as CPU_USAGE,AVG(GPU_USAGE) as GPU_USAGE,MAX(GPU_RUNTIME) as GPU_RUNTIME,MAX(CPU_RUNTIME) as CPU_RUNTIME 
from RUNTIME GROUP BY VM_ID;
